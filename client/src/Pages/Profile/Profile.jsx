    ...
    <>
      <div className="row">
        <div className="col-md-12">
          ...
          >
            <span className="text-primary" style={{ fontFamily: "cursive" }}>
              My
            </span>{" "}
            Profile
          </h1>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <PasswordInput
                ...
                error={
                  errors.oldpassword && touched.oldpassword ? 1 : undefined
                }
              ...
              <PasswordInput
                ...
                error={
                  errors.newpassword && touched.newpassword ? 1 : undefined
                }
